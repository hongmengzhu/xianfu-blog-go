...
func init() {
	gs.Provide(new(TeamController)).Name("SystemTeamController").Export(gs.As[routerPg.RouteRegistrar]())
}
...
func (c *TeamController) RegisterRoutes(e *gin.Engine) {
	group := e.Group("/xianfu/sys/ram/team", authPg.GroupSystemMiddleware(c.Sp))
