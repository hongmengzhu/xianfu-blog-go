...
import (
	...
	"github.com/hongmengzhu/xianfu-blog-go/app/domain/system/basic/service"
...
func init() {
	gs.Provide(new(BasicModuleController)).Name("SystemModuleController").Export(gs.As[routerPg.RouteRegistrar]())
}
...
func (c *BasicModuleController) RegisterRoutes(e *gin.Engine) {
	group := e.Group("/xianfu/sys/basic/module", authPg.GroupSystemMiddleware(c.Sp))
