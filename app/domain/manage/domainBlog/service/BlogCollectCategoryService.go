...
func init() {
	gs.Provide(new(BlogCollectCategoryService))
}
...
func (c *BlogCollectCategoryService) Create(ctx *gin.Context, ct modBlogCollectCategory.CreateCt) (rt rg.Rs[string]) {
	...
	parent := &entityBlog.BlogCollectCategoryEntity{}
	r := c.sv
	//判断是否是自动,不是自动
...
//	@receiver c
//	@param id
func (c *BlogCollectCategoryService) childParentIdLink(maps map[string][]*entityBlog.BlogCollectCategoryEntity, parent *entityBlog.BlogCollectCategoryEntity) {
	key := parent.ParentNo
...
func (c *BlogCollectCategoryService) CacheOverride(ctx *gin.Context) {
	...
	maps := slicePg.ToMapArray(infos, func(t *entityBlog.BlogCollectCategoryEntity) (string, *entityBlog.BlogCollectCategoryEntity) {
		if strPg.IsBlank(t.ParentNo) {
			return constNodePg.ROOT, t
		}
		return t.ParentNo, t
...
//	@receiver c
//	@param id
func (c *BlogCollectCategoryService) Detail(ctx *gin.Context, id int64) (rt rg.Rs[modBlogCollectCategory.Vo]) {
	if id < 1 {
		return rt.ErrorMessage("id错误")
	}
	...
	var info modBlogCollectCategory.Vo
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) Enable(ctx *gin.Context, ct model.BaseIdsCt[string]) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) Disable(ctx *gin.Context, ct model.BaseIdsCt[string]) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) State(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
	if len(ids) < 1 {
		return rt.ErrorMessage("id错误")
	}
	r := c.sv
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) StateEnableDisable(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) SelectNodeAllPublic(ctx *gin.Context, ct modBlogCollectCategory.QueryPublicCt) (rt rg.Rs[[]model.BaseNodeNo]) {
	var query entityBlog.BlogCollectCategoryEntity
	copier.Copy(&query, &ct)
	slice := make([]model.BaseNodeNo, 0)
	rt.Data = slice
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) ExistName(ctx *gin.Context, ct model.BaseExistWdCt[string]) (rt rg.Rs[string]) {
	if "" == ct.Wd {
...
//	@receiver c
//	@param ct
func (c *BlogCollectCategoryService) ExistNo(ctx *gin.Context, ct model.BaseExistWdCt[string]) (rt rg.Rs[string]) {
	if "" == ct.Wd {
		return rt.ErrorMessage("关键词不能为空")
	}
	id := "0"
