...
func init() {
	gs.Provide(new(CollectController)).Name("ManageCollectController").Export(gs.As[routerPg.RouteRegistrar]())
}

// CollectController 收集
// @Description:
type CollectController struct {
	routerPg.RouteRegistrar
	Sp *authPg.GroupManageMiddlewareSp `autowire:"?"`
	sv *service.BlogCollectService     `autowire:"?"`
}
...
func (c *CollectController) Create(ctx *gin.Context) {
	var ct modBlogCollect.CreateUpdateCt
...
//	@receiver c
//	@param ctx
func (c *CollectController) Recovery(ctx *gin.Context) {
	var ct model.BaseIdsCt[string]
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
...
//	@receiver c
//	@param ctx
func (c *CollectController) PhysicalDeletion(ctx *gin.Context) {
	var ct model.BaseIdsCt[string]
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
...
//	@receiver c
//	@param ctx
func (c *CollectController) Detail(ctx *gin.Context) {
	param := ctx.Param("id")
...
//	@receiver c
//	@param ctx
func (c *CollectController) Enable(ctx *gin.Context) {
	var ct model.BaseIdsCt[string]
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
...
//	@receiver c
//	@param ctx
func (c *CollectController) Disable(ctx *gin.Context) {
	var ct model.BaseIdsCt[string]
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
...
//	@receiver c
//	@param ctx
func (c *CollectController) State(ctx *gin.Context) {
...
//	@receiver c
//	@param ctx
func (c *CollectController) Query(ctx *gin.Context) {
	var ct modBlogCollect.QueryCt
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
...
func (c *CollectController) SelectNodePublic(ctx *gin.Context) {
	ct := modBlogCollect.QueryCt{State: enumStatePg.ENABLE.IndexPg()}
	ctx.JSON(200, c.sv.SelectNodePublic(ctx, ct))
}

func (c *CollectController) SelectNodeAllPublic(ctx *gin.Context) {
	ct := modBlogCollect.QueryCt{State: enumStatePg.ENABLE.IndexPg()}
	ctx.JSON(200, c.sv.SelectNodeAllPublic(ctx, ct))
}

func (c *CollectController) SelectPublic(ctx *gin.Context) {
	ct := modBlogCollect.QueryCt{State: enumStatePg.ENABLE.IndexPg()}
...
//	@receiver c
//	@param ctx
func (c *CollectController) ExistName(ctx *gin.Context) {
...
//	@receiver c
//	@param ctx
func (c *CollectController) ExistNo(ctx *gin.Context) {
	var ct model.BaseExistWdCt[string]
	if !routerPg.BindJson(ctx, &ct) {
		return
	}
