...
func init() {
	gs.Provide(new(MenuController)).Name("ManageMenuController").Export(gs.As[routerPg.RouteRegistrar]())
}
...
func (c *MenuController) RegisterRoutes(e *gin.Engine) {
	group := e.Group("/xianfu/manage/ram/menu", authPg.GroupManageMiddleware(c.Sp))
...
//	@receiver c
//	@param ctx
func (c *MenuController) State(ctx *gin.Context) {
...
func (c *MenuController) SelectNodePublic(ctx *gin.Context) {
...
func (c *MenuController) SelectPublic(ctx *gin.Context) {
