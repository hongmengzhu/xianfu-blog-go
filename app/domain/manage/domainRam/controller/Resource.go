...
import (
	...
	"github.com/hongmengzhu/xianfu-blog-go/app/models/ram/modRamResource"
...
func init() {
	gs.Provide(new(ResourceController)).Name("ManageResourceController").Export(gs.As[routerPg.RouteRegistrar]())
}
...
func (c *ResourceController) RegisterRoutes(e *gin.Engine) {
	group := e.Group("/xianfu/manage/ram/resource", authPg.GroupManageMiddleware(c.Sp))
