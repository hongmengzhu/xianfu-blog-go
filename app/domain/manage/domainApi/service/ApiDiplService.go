...
//	@receiver c
//	@param id
func (c *ApiDiplService) Detail(ctx *gin.Context, id int64) (rt rg.Rs[modApiDipl.Vo]) {
	if id < 1 {
		return rt.ErrorMessage("id错误")
	}
...
//	@receiver c
//	@param ct
func (c *ApiDiplService) State(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
	if len(ids) < 1 {
		return rt.ErrorMessage("id错误")
	}
	r := c.sv
...
//	@receiver c
//	@param ct
func (c *ApiDiplService) StateEnableDisable(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
...
func (c *ApiDiplService) Query(ctx *gin.Context, ct modApiDipl.QueryCt) (rt rg.Rs[pagePg.Paginator[modApiDipl.Vo]]) {
	...
	if page.Total > 0 && page.Data != nil && len(page.Data) > 0 {
		pg := pagePg.NewPaginatorByPageable[modApiDipl.Vo](page.Pageable)
		//字段赋值
