...
// @Description:
type ApiDiplCategoryService struct {
	sv *repositoryApi.ApiDiplCategoryRepository `autowire:"?"`
}
...
//	@param ct
//	@return rt
func (c *ApiDiplCategoryService) Create(ctx *gin.Context, ct modApiDiplCategory.CreateCt) (rt rg.Rs[string]) {
	log.Infof(ctx, log.TagAppDef, "ct=%#v", ct)
	var info entityApi.ApiDiplCategoryEntity
	...
	parent := &entityApi.ApiDiplCategoryEntity{}
	r := c.sv
	//判断是否是自动,不是自动
...
//	@param ct
//	@return rt
func (c *ApiDiplCategoryService) Update(ctx *gin.Context, ct modApiDiplCategory.UpdateCt) (rt rg.Rs[string]) {
	log.Infof(ctx, log.TagAppDef, "ct=%#v", ct)
	var info entityApi.ApiDiplCategoryEntity
	copier.Copy(&info, &ct)
	if ct.ID < 1 {
	...
	if strPg.IsNotBlank(ct.ParentNo) && nil != childData {
		maps := slicePg.ToMapArray(childData, func(t *entityApi.ApiDiplCategoryEntity) (string, *entityApi.ApiDiplCategoryEntity) {
...
//	@receiver c
//	@param id
func (c *ApiDiplCategoryService) childParentIdLink(maps map[string][]*entityApi.ApiDiplCategoryEntity, parent *entityApi.ApiDiplCategoryEntity) {
	key := parent.ParentNo
...
func (c *ApiDiplCategoryService) CacheOverride(ctx *gin.Context) {
	...
	maps := slicePg.ToMapArray(infos, func(t *entityApi.ApiDiplCategoryEntity) (string, *entityApi.ApiDiplCategoryEntity) {
		if strPg.IsBlank(t.ParentNo) {
			return constNodePg.ROOT, t
		}
		return t.ParentNo, t
...
//	@receiver c
//	@param id
func (c *ApiDiplCategoryService) Detail(ctx *gin.Context, id int64) (rt rg.Rs[modApiDiplCategory.Vo]) {
	if id < 1 {
		return rt.ErrorMessage("id错误")
	}
	...
	var info modApiDiplCategory.Vo
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) Enable(ctx *gin.Context, ct model.BaseIdsCt[string]) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) Disable(ctx *gin.Context, ct model.BaseIdsCt[string]) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) State(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
	if len(ids) < 1 {
		return rt.ErrorMessage("id错误")
	}
	r := c.sv
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) StateEnableDisable(ctx *gin.Context, ids []string, state enumStatePg.State) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) LogicalDeletion(ctx *gin.Context, ids []string) (rt rg.Rs[string]) {
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) LogicalRecovery(ctx *gin.Context, ids []string) (rt rg.Rs[string]) {
	log.Infof(ctx, log.TagAppDef, "ct=%+v", ids)
	if len(ids) < 1 {
		return rt.ErrorMessage("id错误")
	}
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) PhysicalDeletion(ctx *gin.Context, ids []string) (rt rg.Rs[string]) {
	log.Infof(ctx, log.TagAppDef, "ct=%+v", ids)
	if len(ids) < 1 {
		return rt.ErrorMessage("id错误")
	}
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) SelectNodePublic(ctx *gin.Context, ct modApiDiplCategory.QueryPublicCt) (rt rg.Rs[[]model.BaseNodeNo]) {
	var query entityApi.ApiDiplCategoryEntity
	copier.Copy(&query, &ct)
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) SelectNodeAllPublic(ctx *gin.Context, ct modApiDiplCategory.QueryPublicCt) (rt rg.Rs[[]model.BaseNodeNo]) {
	var query entityApi.ApiDiplCategoryEntity
	copier.Copy(&query, &ct)
	slice := make([]model.BaseNodeNo, 0)
	rt.Data = slice
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) SelectPublic(ctx *gin.Context, ct modApiDiplCategory.QueryPublicCt) (rt rg.Rs[[]modApiDiplCategory.Vo]) {
	var query entityApi.ApiDiplCategoryEntity
	copier.Copy(&query, &ct)
	slice := make([]modApiDiplCategory.Vo, 0)
	rt.Data = slice
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) ExistName(ctx *gin.Context, ct model.BaseExistWdCt[string]) (rt rg.Rs[string]) {
	if "" == ct.Wd {
...
//	@receiver c
//	@param ct
func (c *ApiDiplCategoryService) ExistNo(ctx *gin.Context, ct model.BaseExistWdCt[string]) (rt rg.Rs[string]) {
	if "" == ct.Wd {
		return rt.ErrorMessage("关键词不能为空")
	}
	id := "0"
