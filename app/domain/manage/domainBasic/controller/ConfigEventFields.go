...
import (
	...
	"github.com/hongmengzhu/xianfu-blog-go/app/models/basic/modBasicConfigEventFields"
...
func init() {
	gs.Provide(new(ConfigEventFieldsController)).Name("ManageConfigEventFieldsController").Export(gs.As[routerPg.RouteRegistrar]())
}
