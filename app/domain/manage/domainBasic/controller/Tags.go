...
import (
	...
	"github.com/hongmengzhu/xianfu-blog-go/app/models/basic/modBasicTags"
...
func init() {
	gs.Provide(new(TagsController)).Name("ManageTagsController").Export(gs.As[routerPg.RouteRegistrar]())
}
