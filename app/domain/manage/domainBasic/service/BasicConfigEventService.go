...
import (
	...
	configEvent2 "github.com/hongmengzhu/xianfu-blog-go/app/domain/manage/domainBasic/service/configEvent"
...
func (c *BasicConfigEventService) CreateUpdate(ctx *gin.Context, ct modBasicConfigEvent.CreateUpdateCt) (rt rg.Rs[string]) {
	return configEvent2.NewCreateUpdate(c.sp, ct, true).Process(ctx)
}

// Detail 详情
func (c *BasicConfigEventService) Detail(ctx *gin.Context, id string) (rt rg.Rs[modBasicConfigEvent.CreateUpdateCt]) {
	return configEvent2.NewDetail(c.sp).Process(ctx, id)
}
