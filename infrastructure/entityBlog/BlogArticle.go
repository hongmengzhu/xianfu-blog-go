...
type BlogArticleEntity struct {
	...
	TypeTopic        string                       `gorm:"column:type_topic;type:varchar(80);index;default:no;comment:话题类型|允许话题|不允许话题;" json:"type_topic" comment:"话题类型|允许话题|不允许话题" `
...
func (*BlogArticleEntity) TableComment() string {
	return "文章"
}
