...
// BlogBookmarkCategoryEntity -
type BlogBookmarkCategoryEntity struct {
...
func (*BlogBookmarkCategoryEntity) TableName() string {
	return "blog_bookmark_category"
}

func (*BlogBookmarkCategoryEntity) TableComment() string {
	return "书签分类"
}
