...
// BlogBookmarkEntity 书签
type BlogBookmarkEntity struct {
	...
	Name             string                       `gorm:"column:name;type:varchar(955);comment:名称" json:"name" comment:"名称" `                                                                                // 名称
	...
	UrlSourceMd5     string                       `gorm:"column:url_source_md5;type:varchar(80);index;default:;comment:来源地址md5" json:"url_source_md5" comment:"来源地址md5"`
	...
	TypeOwner        string                       `gorm:"column:type_owner;type:varchar(80);index;default:'general';comment:类型|普通|团队|个人" json:"type_owner" comment:"类型;普通;团队;个人" `
	TeamNo           string                       `gorm:"column:team_no;type:varchar(80);index;default:;comment:团队编号" json:"team_no" comment:"团队编号" `
}

func (*BlogBookmarkEntity) TableName() string {
	return "blog_bookmark"
}

func (*BlogBookmarkEntity) TableComment() string {
	return "书签"
}
