...
// ApiDiplCategoryEntity -
type ApiDiplCategoryEntity struct {
...
func (*ApiDiplCategoryEntity) TableName() string {
	return "api_dipl_category"
}

func (*ApiDiplCategoryEntity) TableComment() string {
	return "分类"
}
