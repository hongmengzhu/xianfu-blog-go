...
// RamAppCategoryEntity -
type RamAppCategoryEntity struct {
...
func (*RamAppCategoryEntity) TableName() string {
	return "ram_app_category"
}

func (*RamAppCategoryEntity) TableComment() string {
	return "分类"
}
