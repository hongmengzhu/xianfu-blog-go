...
type RamRoleEntity struct {
	...
	TypeSys     int64      `gorm:"column:type_sys;type:int4;not null;index;default:1;comment:类型|普通|系统|api" json:"type" comment:"类型;普通;系统;api" `         // 类型
	TypeGroup   int64      `gorm:"column:type_group;type:int4;not null;index;default:1;comment:类型分组\\;用户\\;部门" json:"type_group" comment:"类型分组;用户;部门" ` // 类型分组
}

// TableName RamRoleEntity's table name
func (*RamRoleEntity) TableName() string {
	return "ram_role"
}

func (*RamRoleEntity) TableComment() string {
	return "角色"
}
