...
// BasicConfigCategoryEntity -
type BasicConfigCategoryEntity struct {
...
func (*BasicConfigCategoryEntity) TableName() string {
	return "basic_config_category"
}

func (*BasicConfigCategoryEntity) TableComment() string {
	return "分类"
}
