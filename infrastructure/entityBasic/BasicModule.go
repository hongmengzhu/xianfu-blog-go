...
// BasicModuleEntity 模块/分类
type BasicModuleEntity struct {
	...
	Code        string     `gorm:"column:code;type:varchar(80);index;default:;comment:码值" json:"code" comment:"码值" `                                                                  // 编号代号
	...
	ParentCode  string     `gorm:"column:parent_code;type:varchar(80);index;comment:上级" json:"parent_code" comment:"上级" `
	CodeLink    string     `gorm:"column:code_link;type:varchar(5000);comment:上级" json:"code_link" comment:"上级链" `
	ParentNo    string     `gorm:"column:parent_no;type:varchar(80);index;default:;comment:上级" json:"parent_no" comment:"上级" `
	NoLink      string     `gorm:"column:no_link;type:varchar(5000);comment:上级" json:"no_link" comment:"上级链" `
...
func (*BasicModuleEntity) TableName() string {
	return "basic_module"
}

func (*BasicModuleEntity) TableComment() string {
	return "模块"
}
